    ...
    def preprocess(self, examples, tokenizer):
        ...
        for ex in tqdm(examples):
            ...
            for answer in ex['answers']:
                text = f"Q: {questions}\nA: {answer}\n"
                tokenized = tokenizer.encode(text, truncation=True, max_length=128)  # Truncating to max length
...
if __name__ == "__main__":
    ...
    parser.add_argument("--data_path", type=str, default="data/sample.json")
